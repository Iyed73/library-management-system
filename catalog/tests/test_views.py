...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name="Ethan",
                                            last_name="Stevens")
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        test_user1 = User.objects.create_user(username='testuser1', password='somerandompassword')
        test_user2 = User.objects.create_user(username='testuser2', password='somerandompassword')
